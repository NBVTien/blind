...
function AlertDialogAction({
  ...
  return (
    <AlertDialogPrimitive.Action
      className={cn(buttonVariants({ variant: "destructive" }), "font-display tracking-widest text-xs", className)}
      {...props}
    />
  )
}
...
function AlertDialogCancel({
  ...
  return (
    <AlertDialogPrimitive.Cancel
      className={cn(buttonVariants({ variant: "outline" }), "font-display tracking-widest text-xs", className)}
      {...props}
    />
  )
}
